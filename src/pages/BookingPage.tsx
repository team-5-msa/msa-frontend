...
export default function BookingPage() {
    ...
    const { performance, seatCount } = location.state as { performance: Performance; seatCount: number };
    ...
    const handleReservation = async () => {
        try {
            ...
            setError(err.response?.data?.message || err.message || '예약에 실패했습니다.');
        } finally {
            setLoading(false);
        }
    };
    ...
    const handlePayment = async () => {
        ...
        try {
            ...
            const errorMsg = err.response?.data?.message || err.message || '결제에 실패했습니다.';
            setError(errorMsg);
        ...
        <div className="booking-page">
            ...
            <div className="booking-container">
                ...
                <div className="progress-steps">
                    ...
                    <div className={`step ${step === 'payment' ? 'active' : step === 'complete' ? 'completed' : ''}`}>
